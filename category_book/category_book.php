            ...
            <div id="content">
                ...
                <table  class ='table table-striped table-hover'>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href = "update_category.php?Id=<?php echo $r['ID'];?>">Edit</a>
                        </td>
                        <td>
                        <a onclick = "return confirm('Are you sure?')"; href="../process/delete.php?Id=<?php echo $r['ID'];?>&file=categories">Delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </table>
                <form style = 'margin-left:15px;' action='insert_category.php' method = 'POST'>
