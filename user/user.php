            ...
            <div id="content">
                ...
                <table  class ='table table-striped table-hover'>
                    ...
                    <tr>
                        ...
                        <td><?php echo $r['CCCD']; ?></td>
                        <td>
                            <a href = "update_user.php?Id=<?php echo $r['ID'];?>&file=user" >Edit</a>
                        </td>
                        <td>
                        <a onclick = "return confirm('Are you sure?')"; href="../process/delete.php?Id=<?php echo $r['ID'];?>&file=user">Delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </table>
                <form style = 'margin-left:15px;' action='insert_user.php' method = 'POST'>
